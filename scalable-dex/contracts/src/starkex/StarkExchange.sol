...
contract StarkExchange is MainDispatcher {
    ...
    // TODO: add our new version (StarkWare_TokensAndRamping_2021_1)? but how?
    //
    ...
    uint256 constant IDX_MAP_0 =
        0x2000000000000000002010000001000000000000200010300010002002000330;
    uint256 constant IDX_MAP_1 =
        0x4300000202002011010000101200100030000000022030010000000121000000;
    uint256 constant IDX_MAP_2 =
        0x2000000100300230002000400000000001013000201010100001011000;
    uint256 constant IDX_MAP_3 =
        0x2020000003002002000002020000000002000000000001200320000000002000;
        ...
        returns (string memory id)
    {
        if (index == 1) {
            ...
            id = "StarkWare_TokensAndRamping_2021_1";
        } else if (index == 3) {
